import learnmeet from './learnmeet.jpg'
import library from './library.jpg'
import webdesign from './webdesign.jpg'
import developmet from './development.jpg'
import appdesign from './appdesign.jpg'
import gamedesign from './gamedesign.jpg'
import contentwriter from './contentwriter.jpg'
                ...
                <div id="header-carousel" class="carousel slide carousel-fade" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active" style={{ minHeight: "300px" }}>
                            <img class="position-relative w-100" src={learnmeet} style={{ minHeight: "300px", objectfit: "cover" }} />
            ...
            <div class="container-fluid py-5">
                <div class="container py-5">
                    <div class="row align-items-center">
                        <div class="col-lg-5">
                            <img class="img-fluid rounded mb-4 mb-lg-0" src={library} alt="" />
                        </div>
                        <div class="col-lg-7">
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-6 mb-4">
                            <div class="cat-item position-relative overflow-hidden rounded mb-2">
                                <img class="img-fluid" src={webdesign} alt="webdesign" />
                        ...
                        <div class="col-lg-3 col-md-6 mb-4">
                            <div class="cat-item position-relative overflow-hidden rounded mb-2">
                                <img class="img-fluid" src={developmet} alt="developmet" />
                                <a class="cat-overlay text-white text-decoration-none" href="">
                        ...
                        <div class="col-lg-3 col-md-6 mb-4">
                            <div class="cat-item position-relative overflow-hidden rounded mb-2">
                                <img class="img-fluid" src={gamedesign} alt="gamedesign" />
                                <a class="cat-overlay text-white text-decoration-none" href="">
                        ...
                        <div class="col-lg-3 col-md-6 mb-4">
                            <div class="cat-item position-relative overflow-hidden rounded mb-2">
                                <img class="img-fluid" src={appdesign} alt="appdesign" />
                                <a class="cat-overlay text-white text-decoration-none" href="">
                        ...
                        <div class="col-lg-3 col-md-6 mb-4">
                            <div class="cat-item position-relative overflow-hidden rounded mb-2">
                                <img class="img-fluid" src={marketing} alt="marketing" />
                                <a class="cat-overlay text-white text-decoration-none" href="">
                        ...
                        <div class="col-lg-3 col-md-6 mb-4">
                            <div class="cat-item position-relative overflow-hidden rounded mb-2">
                                <img class="img-fluid" src={research} alt="research" />
                                <a class="cat-overlay text-white text-decoration-none" href="">
                        ...
                        <div class="col-lg-3 col-md-6 mb-4">
                            <div class="cat-item position-relative overflow-hidden rounded mb-2">
                                <img class="img-fluid" src={contentwriter} alt="contentwriter" />
                                <a class="cat-overlay text-white text-decoration-none" href="">
                        ...
                        <div class="col-lg-3 col-md-6 mb-4">
                            <div class="cat-item position-relative overflow-hidden rounded mb-2">
                                <img class="img-fluid" src={seo} alt="seo" />
                                <a class="cat-overlay text-white text-decoration-none" href="">
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-6 mb-4">
                            <div class="rounded overflow-hidden mb-2">
                                <img class="img-fluid" src={course1} alt="course1" />
                        ...
                        <div class="col-lg-4 col-md-6 mb-4">
                            <div class="rounded overflow-hidden mb-2">
                                <img class="img-fluid" src={course2} alt="course2" />
                                <div class="bg-secondary p-4">
                                    <div class="d-flex justify-content-between mb-3">
                                        <small class="m-0"><i class="fa fa-users text-primary mr-2"></i>25 Students</small>
                                        <small class="m-0"><i class="far fa-clock text-primary mr-2"></i>01h 30m</small>
                        ...
                        <div class="col-lg-8">
                            <div class="owl-carousel testimonial-carousel">
                                <div class="text-center">
                                    ...
                                    <img class="img-fluid mx-auto mb-3" src={testimonial1} alt=""/>
